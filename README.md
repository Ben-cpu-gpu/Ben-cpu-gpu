      ...
      >
        <title id="titleId">Nekrxs' GitHub Stats, Rank: B</title>
        <desc id="descId">Total Stars Earned: 674, Total Commits  : 535, Total PRs: 1, Total Issues: 0, Contributed to (last year): 1</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 140.6652019165063;
      }
    }
